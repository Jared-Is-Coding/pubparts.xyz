                ...
                <Container>
                    <Row>
                        ...
                        <Col xs={12} md={6}>
                            <Card>
                                {/* Part image */}
                                <div className="card-img-holder" onClick={() => setPreviewLightboxToggler(!previewLightboxToggler)} style={{ backgroundImage: previewImageUrl ? `url('${previewImageUrl}')` : "" }}>
                                    {item.imageSrc &&
                                ...
                                {item.imageSrc &&
                                    <Lightbox src={previewImageUrls} toggler={previewLightboxToggler} />
                                }
                            </Card>
                        </Col>
                        ...
                        <Col xs={12} md={12}>
                            ...
                            <Row>
                                <Col xs={12} md={4}>
                                    <Card>
                                        {/* Part image */}
                                        <div className="card-img-holder" onClick={() => setStep0LightboxToggler(!step0LightboxToggler)} style={{ backgroundImage: `url('${getImageUrl("/images/shop/zhooks/step0.jpg")}')` }}>
                                            {item.imageSrc &&
                                    ...
                                    <Lightbox src={[getImageUrl("/images/shop/zhooks/step0.jpg")]} toggler={step0LightboxToggler} />
                                </Col>

                                <Col xs={12} md={4}>
                                    <Card>
                                        {/* Part image */}
                                        <div className="card-img-holder" onClick={() => setStep1LightboxToggler(!step1LightboxToggler)} style={{ backgroundImage: `url('${getImageUrl("/images/shop/zhooks/step1.2.jpg")}')` }}>
                                            {item.imageSrc &&
                                    ...
                                    <Lightbox src={[getImageUrl("/images/shop/zhooks/step1.2.jpg"), getImageUrl("/images/shop/zhooks/step1.1.jpg")]} toggler={step1LightboxToggler} />
                                </Col>
                                ...
                                <Col xs={12} md={4}>
                                    <Card>
                                        {/* Part image */}
                                        <div className="card-img-holder" onClick={() => setStep2LightboxToggler(!step2LightboxToggler)} style={{ backgroundImage: `url('${getImageUrl("/images/shop/zhooks/step2.jpg")}')` }}>
                                            {item.imageSrc &&
                                    ...
                                    <Lightbox src={[getImageUrl("/images/shop/zhooks/step2.jpg")]} toggler={step2LightboxToggler} />
                                </Col>

                                <Col xs={12} md={4}>
                                    <Card>
                                        {/* Part image */}
                                        <div className="card-img-holder" onClick={() => setStep3LightboxToggler(!step3LightboxToggler)} style={{ backgroundImage: `url('${getImageUrl("/images/shop/zhooks/step3.jpg")}')` }}>
                                            {item.imageSrc &&
                                    ...
                                    <Lightbox src={[getImageUrl("/images/shop/zhooks/step3.jpg")]} toggler={step3LightboxToggler} />
                                </Col>

                                <Col xs={12} md={4}>
                                    <Card>
                                        {/* Part image */}
                                        <div className="card-img-holder" onClick={() => setStep4LightboxToggler(!step4LightboxToggler)} style={{ backgroundImage: `url('${getImageUrl("/images/shop/zhooks/step4.jpg")}')` }}>
                                            {item.imageSrc &&
                                    ...
                                    <Lightbox src={[getImageUrl("/images/shop/zhooks/step4.jpg")]} toggler={step4LightboxToggler} />
                                </Col>

                                <Col xs={12} md={4}>
                                    <Card>
                                        {/* Part image */}
                                        <div className="card-img-holder" onClick={() => setStep5LightboxToggler(!step5LightboxToggler)} style={{ backgroundImage: `url('${getImageUrl("/images/shop/zhooks/step5.jpg")}')` }}>
                                            {item.imageSrc &&
                                    ...
                                    <Lightbox src={[getImageUrl("/images/shop/zhooks/step5.jpg")]} toggler={step5LightboxToggler} />
                                </Col>
                            </Row>
                        </Col>
                    </Row>
