const allResources = [
	{
		...
		description:
			"Floaty is a companion app for VESC®-based balance skateboards, focused on providing a modern, sleek experience",
	},
	{
		title: "VESC Tool",
		typeOfResource: ["Tools"],
		...
		description:
			"This is the mobile version of VESC Tool, which can be used to configure VESC®-based hardware over BLE",
	},
	{
	...
	},
	{
		...
		description:
			'"Custom and repairable OneWheel parts, creating similarly functioning parts for each board frame type"',
	},
	{
	...
	},
	{
		...
		description:
			"A comprehensive compilation of essential information and responses to FAQ's within the Onewheel VESC community",
	},
	{
		title: "PEV.dev",
		typeOfResource: ["Website"],
	...
	},
	{
		...
		description:
			"Find the right setup for your needs. Push your board to your limits. We can help you with any setup you request.",
	},
	{
		...
		description:
			"Top notch products and services to level up your riding and keep you at the top of your game. Level Up Here!",
	},
	{
