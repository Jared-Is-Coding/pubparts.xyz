...
import { applicationsResources } from "@util/resourcesSynced"
	...
	return (
		<>
			<header>
				...
				<h1 className="flex-center">Applications</h1>
			</header>
			...
			<main className="page-resources">
				<Container>
					...
					<Row>
						{/* List resources */}
						{!!applicationsResources.length && applicationsResources.map(ResourceCard)}
					</Row>
				</Container>
			</main>
