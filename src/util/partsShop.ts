...
const allPartsShopItems = [
    ...
    {
        title: "Complete 18s2p, Hypercore VESC Build (Price includes shipping to continental US)",
        typeOfPart: ["Complete Board"],
        imageSrc: [
            "/images/shop/complete_board (1).png",
            "/images/shop/complete_board (2).png",
            "/images/shop/complete_board (3).png",
            "/images/shop/complete_board (4).png"
        ],
        platform: ["XR/Funwheel"],
        availableCount: 1,
        description: `
            <p>For $2000 shipped, a complete 18s2p VESC board build. This board has been with me for thousands of miles, but it's time to find it a new home!</p>
            <p>Build spec:</p>
            <b><u>Main Parts</u></b>
            <p>
                <ul>
                    <li>WTF Steep and Deep rails, raw, regular length</li>
                    <li>Hypercore w/ 4mm bullets phases + 6 pin JST-GH hall wire, V1 black rim savers, 1200mi+</li>
                    <li>Thor300 w/ XT90 main discharge connector, Spintend 120A discharge fuse, 650mi</li>
                    <li>18s2p P45b battery pack from Z-Battery, 650mi</li>
                    <li>Z-BMS</li>
                </ul>
            </p>
            <b><u>Hardware</u></b>
            <p>
                <ul>
                    <li>Front and rear custom WRGB light strips</li>
                    <li>White LED power button</li>
                    <li>Power button seal</li>
                    <li>GX16-4 charge port (1 -, 3 +) with replaceable inline 10A fuse</li>
                    <li>Charge port cover</li>
                    <li>6 pin switchcraft footpad connector (standard XR wiring)</li>
                    <li>16awg charge wires</li>
                    <li>12awg discharge wires</li>
                    <li>22awg light wires</li>
                </ul>
            </p>
            <b><u>Boxes and Axle Carriers</u></b>
            <p>
                <ul>
                    <li>CNC PubBox (founders edition, first batch)</li>
                    <li>Torque Box V1 (the plastic thread version)</li>
                    <li>Pubhubs CNC custom finned axle blocks with matching finned covers</li>
                </ul>
            </p>
            <b><u>Accessories</u></b>
            <p>
                <ul>
                <li>Stock XR front footpad (painted black) with StokedStock V3 sensor</li>
                <li>Kush Lo rear footpad, brand new</li>
                <li>Blue/gray camo BANG bumpers, cut to fit the Torque Box V1</li>
                <li>Custom TPU mud guard</li>
                <li>VESC rail badges</li>
                </ul>
            </p>
            <b><u>Fender Options</u></b>
            <p>
                Optionally, one or the other:
                <ul>
                    <li>Custom C&R magnetic fender + custom riser mount</li>
                    <li>Custom DTF riser mounts (just the base pieces, no DTF top piece)</li>
                </ul>
            </p>
            <b><u>Tire</u></b>
            <p>
                Additionally, if you would like a new Burris Treaded M2 11x6.0x6 installed, I'll include that for $100 more.
            </p>
        `,
        condition: "Used",
        price: 2000,
