...
export const Head: HeadFC = () => (
	<>
		<html lang="en" />
		<SiteMetaData title="Vendors | Resources | PubParts.xyz" description="Various resources for VESC builders" />
	</>
)
		...
		<>
			...
			<main className="page-resources">
				<Container>
					...
					<Row>
						{/* List resources */}
						{!!vendorsResources.length && vendorsResources.map(ResourceCard)}
					</Row>
				</Container>
			</main>
