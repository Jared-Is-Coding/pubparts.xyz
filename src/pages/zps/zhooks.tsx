                        ...
                        <Col xs={12} md={12}>
                            ...
                            <Row>
                                ...
                                <Col xs={12} md={4}>
                                    <Card>
                                        {/* Part image */}
                                        <div className="card-img-holder" onClick={() => setStep1LightboxToggler(!step1LightboxToggler)} style={{backgroundImage: `url('/images/shop/zhooks/step1.1.jpg')`}}>
                                            {item.imageSrc &&
                                        ...
                                        <Card.Body>
                                            <Card.Title as="h3" className="flex-center">Step 1</Card.Title>

                                            <Card.Text>
                                                Front footpad with Stompie Sensor, StokedStock Sensor, or other non-FM sensor:
                                                Place the wedge on the footpad, aligning the outer hole with the outer side edge of the footpad.
                                            </Card.Text>
                                            <Card.Text>
                                                Front footpad with magnet sensor, SS V5, or other cuttable sensor:
                                                Place the wedge on the footpad wherever you would like!
                                            </Card.Text>
                                            <Card.Text>
                                    ...
                                    <Lightbox src={["/images/shop/zhooks/step1.1.jpg", "/images/shop/zhooks/step1.2.jpg"]} toggler={step1LightboxToggler} />
                                </Col>
