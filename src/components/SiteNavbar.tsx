...
const allPartsAndResources = [...new Set([allParts, allResources].flat())] as (ItemData | ResourceData)[]
		...
		<Navbar fixed="top" expand="lg" data-bs-theme="dark">
			<Container>
				<Navbar.Brand href="/">
					...
					<span className={isHomepage ? "d-none" : "d-none d-md-inline-block"}>PubParts.xyz</span>
				</Navbar.Brand>

				<Stack direction="horizontal" gap={3}>
					{/* Mobile Search Button */}
					<Nav.Link
						className="d-md-block d-lg-none navbar-toggler"
						onClick={() => setShowModal(true)}
						aria-label="Sitewide search modal trigger">
						<FaMagnifyingGlass style={{ height: "1rem", width: "1rem" }} />
					</Nav.Link>
					{/* Mobile Navigation Toggle */}
					<Navbar.Toggle label="Menu toggle" aria-controls="site-navbar">
						<FaBars style={{ height: "1rem", width: "1rem" }} />
					</Navbar.Toggle>
				</Stack>
				...
				<Navbar.Collapse id="site-navbar">
					<Nav variant="underline" justify>
						...
						<NavDropdown
							...
							id="nav-parts-dropdown">
							<NavDropdown.Item href="/parts/floatwheel" target="_self">
								Floatwheel
							</NavDropdown.Item>
							<NavDropdown.Item href="/parts/gt" target="_self">
								GT/GT-S
							</NavDropdown.Item>
							<NavDropdown.Item href="/parts/pint" target="_self">
								Pint/X/S
							</NavDropdown.Item>
							<NavDropdown.Item href="/parts/xr" target="_self">
								XR/Funwheel
							</NavDropdown.Item>
							<NavDropdown.Item href="/parts/xrclassic" target="_self">
								XR Classic
							</NavDropdown.Item>
							<NavDropdown.Item href="/parts/misc" target="_self">
								Miscellaneous Items
							</NavDropdown.Item>
							<NavDropdown.Item href="/parts/electronics" target="_self">
								VESC Electronics
							</NavDropdown.Item>
							<NavDropdown.Item href="/zps" target="_self">
								ZiNc's Parts Shop
							</NavDropdown.Item>
						</NavDropdown>
						<NavDropdown
				...
				<Modal
					...
					<Modal.Body>
						...
						<Stack direction="vertical" gap={3}>
							{/* List parts */}
							{!!allPartsAndResources.length && allPartsAndResources.map(SearchModalCard)}
						</Stack>
					</Modal.Body>
