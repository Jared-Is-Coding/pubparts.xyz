const allPartsShopItems = [
	...
	},
	{
		...
		availableCount: -1,
		description:
			"Slim battery box mud guard for the Onewheel XR, providing cutouts for the battery harness M20 gland and wires and keeping water and dirt out of your bumpers and battery box edges. Tested with TFL BANG Bumpers and stock bumpers.",
		condition: "New",
		price: 10,
	},
	{
	...
	},
	{
		...
		typeOfPart: ["Fender"],
		imageSrc:
			"https://media.printables.com/media/prints/1138681/images/8592011_a22ebc36-5500-4b91-bc6d-25abd7e67a79_c3dfef4f-c5f8-492f-9ba3-55e2a3e1ebaf/thumbs/inside/1280x960/jpg/8799e700-c0af-4686-a63a-aad2cb9b1d7b.webp",
	...
	},
	{
		...
		availableCount: 1,
		description:
			"Stock XR battery harness with most of the battery box ends chopped up or otherwise removed. Good for parts or splicing up for your own builds.",
		condition: "Used",
		price: 25,
	},
	{
		...
		typeOfPart: ["Footpad"],
		imageSrc: ["/images/shop/airpad1.png", "/images/shop/airpad2.png"],
		platform: ["XR/Funwheel"],
		availableCount: 1,
		condition: "Used",
		price: 50,
	},
	{
		...
		typeOfPart: ["Controller"],
		imageSrc: ["/images/shop/thor300imu.png"],
	...
	},
	{
		...
		typeOfPart: ["Controller"],
		imageSrc: ["/images/shop/thor400ic1.png", "/images/shop/thor400ic2.png", "/images/shop/thor400ic3.png"],
		externalUrl: "",
		platform: ["VESC Electronics"],
		availableCount: 1,
		description:
			"Thor400 with a blown IC. Has never been installed in a board - This IC blew on first boot, with nothing connected but power and a button. No other known issues.",
		condition: "For Parts",
		price: 200,
	},
] as PartsShopData[]
