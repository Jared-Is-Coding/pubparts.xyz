...
import { websitesResources } from "@util/resourcesSynced"

export const Head: HeadFC = () => (
	<>
		<html lang="en" />
		<SiteMetaData title="Websites | Resources | PubParts.xyz" description="Various resources for VESC builders" />
	</>
)
	...
	return (
		<>
			<header>
				...
				<h1 className="flex-center">Websites</h1>
			</header>
			...
			<main className="page-resources">
				<Container>
					...
					<Row>
						{/* List resources */}
						{!!websitesResources.length && websitesResources.map(ResourceCard)}
					</Row>
				</Container>
			</main>
